...
def test_filter_outcomes():
    """Assert that outcomes are filtered correctly"""
    cases = (
        (
            make_set((2000, 6), (150, 4), (100, 5), (50, 5)),
            make_set((2000, 6), (150, 4), (100, 5)),
        ),
        (
            make_set((1500, 6), (100, 4), (50, 5)),
            make_set((1500, 6), (100, 4), (50, 5)),
        ),
        (make_set((500, 2), (100, 3), (50, 4)), make_set((500, 2), (100, 3), (50, 4))),
        (make_set((50, 1), (100, 1), (150, 6)), make_set((100, 1), (150, 6))),
        (make_set((50, 2), (100, 2), (150, 1)), make_set((100, 2), (150, 1))),
        (make_set((50, 3)), make_set((50, 3))),
        (make_set((0, DiceCount.BUST)), make_set((0, DiceCount.BUST))),
        (
            make_set((2400, 6), (1200, 1), (600, 2)),
            make_set((2400, 6), (1200, 1), (600, 2)),
        ),
        (make_set((100, 4), (200, 3)), make_set((100, 4), (200, 3))),
        (
            make_set((50, 5), (100, 5), (200, 4), (150, 4), (250, 3)),
            make_set((100, 5), (200, 4), (250, 3)),
        ),
        (
            make_set((100, 5), (200, 4), (1500, 6)),
            make_set((100, 5), (200, 4), (1500, 6)),
        ),
        (
            make_set((100, 5), (200, 4), (300, 3), (400, 2), (500, 1)),
